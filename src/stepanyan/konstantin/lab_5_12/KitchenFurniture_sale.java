...
class KitchenFurniture_sale extends Sales implements Recyclable{
    ...
    public KitchenFurniture_sale(String name,
                            ...
                            double length, double height, double width, String material) {
        super(name,
              countryOfOrigin,
              price,
              discount,
        ...
        this.length = length;  this.height = height;  this.width = width;  this.material = material;
    }
    ...
    @Override public void printDetails(int productNumber) {
        ...
        System.out.println("Высота: "+getHeight()+"см; Ширина: "+getWidth()+
                                   "см; Длина: "+getLength() + "см; Материал: "+getMaterial()+";");
