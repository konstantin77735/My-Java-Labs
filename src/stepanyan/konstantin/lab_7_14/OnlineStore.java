...
public class OnlineStore {
    ...
    protected UtilizeList utilizable_products_list_of_store;
    ...
    public OnlineStore(String name, String owner, String inn, String domen,
                       SalesList sales_list_of_store,
                       ProductList products_list_of_store,
                       UtilizeList utilizable_products_list_of_store) {
        this.name = name;
        this.owner = owner;
        this.inn = inn;
        this.domen = domen;
        this.products_list_of_store = products_list_of_store;
        this.sales_list_of_store = sales_list_of_store;
        this.utilizable_products_list_of_store = utilizable_products_list_of_store;
    }
    ...
    public void printProducts(String order) {
        if(this.products_list_of_store!=null && this.products_list_of_store.size()!=0) {
            ...
            products_list_of_store.printProductsList(order);

        } else {System.out.println("Список товаров пуст."+"\n");}
    }

    public UtilizeList getUtilizableProducts_list_of_store() {return this.utilizable_products_list_of_store;}
    public void setUtilizableProducts_list_of_store(UtilizeList newList) {this.utilizable_products_list_of_store = newList;}

    public void printUtilizableProducts(String order) {
        if(this.utilizable_products_list_of_store!=null && this.utilizable_products_list_of_store.size()!=0) {

            System.out.println("Список товаров: "+"\n");
            utilizable_products_list_of_store.printUtilizeList(order);
